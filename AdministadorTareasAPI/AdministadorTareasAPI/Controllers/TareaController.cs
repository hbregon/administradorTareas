...
namespace AdministadorTareasAPI.Controllers
{
    ...
    public class TareaController : ControllerBase
    {
        ...
        public IActionResult PutTarea([FromBody] Tarea tareaParametro)
        {
            ...
            if (tarea == null)
            {
                return StatusCode(StatusCodes.Status400BadRequest, new { mensaje = "Tarea no encontrada" });
            }
            ...
            try
            {
                ...
                tarea.FechaFinal = tareaParametro.FechaFinal is null ? tarea.FechaFinal : tareaParametro.FechaFinal;
